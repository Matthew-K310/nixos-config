...
# Configuration
WALLPAPER_DIR="$HOME/cloud/photos/wallpapers"
...
IMAGES=$(find "$WALLPAPER_DIR" -type f \( -name "*.jpg" -o -name "*.jpeg" -o -name "*.png" -o -name "*.gif" -o -name "*.webm" -o -name "*.webp" \) | sort)
...
SELECTED_NAME=$(wofi --dmenu -i --width 500 --height 500 --cache-file /dev/null --prompt "Select wallpaper:" --show-images <"$WOFI_INPUT")
