;;; ../../dotfiles/.config/doom/lisp/theo.el -*- lexical-binding: t; -*-

;;; theo.el --- Get a random (or selected) Theo de Raadt quote -*- lexical-binding: t; -*-

;; Copyright (c) Artur Manuel 2025

;; Author: Artur Manuel
;; Version: 2025.04
;; Keywords: games, theo, openbsd
;; URL: https://copeberg.org/amadaluzia/theo.el

;;; Commentary:

;; theo.el is an Emacs package which reads from a list of already available
;; Theo de Raadt quotes (attained from 9front's plan9front repository) and
;; prints them out to the minibuffer.  While it may not do much, you can bet
;; that it does the job damn well.  Call that a UNIX philosophy.

;;; Code:

(declare-function theo "theo" (&optional quote-index))

(defun theo (&optional quote-index)
  "Gets a random quote from Theo de Raadt.
The optional argument QUOTE-INDEX will let a user to pick their quote"
  (interactive)
  (let* ((theo-quotes '("Buttons are for idiots."
                        ...
                        "I suspect noone wants that."
                        "I dunno..."
                        "Incomplete or vague bug reports don't usually result in improvements."
                        "What hogwash."
                        "Don't be stupid."
                        "That is a false history."
                        "How many years did it take to notice this bug?"
                        "I think this a really sad approach."
                        "Let me be clear: the program is lying to the user."
                        ...
                        "I think that procedure is hogwash."
                        ...
                        "Yeah, that won't work out well."
                        "The future doesn't get better if you demand backwards compatibility forever."
                        "The Unix landscape is getting old enough to throw bad ideas out."
                        "what are you trying to say?"
                        "You lost me.."
                        "Doctor! Doctor! It hurts when I stick a knife in here!"
                        "OK, that's ridiculous."
                        "What is the justification?"
                        "You are trying to compare a pig and a moon rocket."
                        "I disagree."
                        "No."
                        "Not going to happen."
                        ...
                        "If we can't do it right, we don't do it until we figure out a way to do it right."
                        "This diff is killing me."
                        "It's going to sound a bit strange, but some things should not be documented."
                        "You've been around for many years, yet you can't be bothered do your homework."
                        "What a sob story"
                        "That's not good enough."
                        "Sometimes doing nothing is better, because it encourages people to be paranoid and careful of bear the consequences."
                        "I have no idea what that sentence means."
                        "Why does this need to be said?"
                        "Noone should follow that advice."
