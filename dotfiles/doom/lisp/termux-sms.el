...
(defcustom termux-sms-contacts-file "~/notes/contacts.org"
  "Path to org file containing contacts."
  :type 'file
  :group 'termux-sms)

;; CHANGE THIS BASED ON NETWORK
;; (defcustom termux-sms-phone-ip "192.168.1.86"
(defcustom termux-sms-phone-ip "100.80.33.123"
...
(defcustom termux-sms-ssh-user "u0_a290"
  "SSH username for Termux."
  :type 'string
  :group 'termux-sms)

(defcustom termux-sms-ssh-key "~/.ssh/id_ed25519"
